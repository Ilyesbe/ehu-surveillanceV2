  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-3xl space-y-6">
        ...
        {/* ── Section 2 — Données Cliniques ────────────────────────────── */}
        <div className="card">
          <SectionHeader letter="2" title="Données Cliniques" />
          <div className="p-5 grid grid-cols-2 gap-4">
        ...
        {/* ── Section 3 — Lieux Fréquentés (Feature 3) ─────────────────── */}
        <div className="card">
          <SectionHeader letter="3" title="Lieux Fréquentés" />
        ...
        {/* ── Section 4 — Hospitalisation & Évacuation (Features 6 & 7) ── */}
        <div className="card">
          <SectionHeader letter="4" title="Évaluation, Hospitalisation & Évacuation" />
          <div className="p-5 grid grid-cols-2 gap-4">
        ...
        {/* ── Section 5 — Résultats Laboratoire (Features 5 & 8) ───────── */}
        <div className="card">
        ...
        <div className="card">
          <SectionHeader letter="6" title="Informations Médicales" />
          <div className="p-5 grid grid-cols-2 gap-4">
            <div>
              <label className="label">Établissement</label>
              <select {...register("etablissementId")} className={inputCls(false)}>
                <option value="">Sélectionner...</option>
                {etablissements.map(e => (
                  <option key={e.id} value={e.id}>{e.nom}</option>
                ))}
            ...
            <div className="col-span-2">
              ...
              <textarea
                ...
                rows={4}
                className={cn(inputCls(false), "h-auto py-2 resize-none")}
                placeholder="Observations cliniques, antécédents pertinents..."
                maxLength={2000}
              />
            </div>

            <div className="col-span-2">
              <label className="label">Résultat laboratoire (texte libre)</label>
              <textarea
                {...register("resultatLabo")}
                rows={2}
                className={cn(inputCls(false), "h-auto py-2 resize-none")}
                placeholder="Résultats des examens de laboratoire..."
              />
            </div>
          </div>
        </div>
